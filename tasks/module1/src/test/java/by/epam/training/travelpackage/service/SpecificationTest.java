...
import by.epam.training.travelpackage.service.comparator.DurationDescendenceComparator;
import by.epam.training.travelpackage.service.comparator.DurationIncreaseComparator;
import by.epam.training.travelpackage.service.comparator.PriceDescendenceComparator;
import by.epam.training.travelpackage.service.comparator.PriceIncreaseComparator;
...
public class SpecificationTest {
    ...
    public void SelectByNutritionSpecificationTest() {
        ...
        List<TravelTour> allByParameter = travelTourService.getTravelTourRepositoryImpl().findAllByParameter(spec);
        //assert
